WITH
    DEVICE_LIST AS (
        ...
        WHERE
            DEVICE_PAIRS.TOILET_INFO_ID = 'e3b73d18-9fc2-405f-5685-bb21bb73e6c4'
    )
SELECT
...
FROM (
        ...
        WHERE
            ...
            AND (TIMESTAMP) >= TO_TIMESTAMP(
                '2024-11-07 16:00:00', 'YYYY-MM-DD HH24:MI:SS'
            )
    ) Q1
    CROSS JOIN (
        SELECT
    ...
    CROSS JOIN (
        ...
        FROM TOILET_INFOS
        WHERE
            TOILET_INFOS.TOILET_INFO_ID = '1a30dea0-03c9-41d6-5918-b15807c3661f'
    ) Q6
    CROSS JOIN (
